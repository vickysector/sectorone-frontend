export function ExecutiveProtectionsFirstAccess({ Icon, title, descriptions }) {
  return (
    <section className="bg-white border-2 border-input-border rounded-xl p-8 flex items-center">
      <div>
